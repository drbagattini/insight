...
export const intakeFieldsDefinition = [
  ...
  { step: 3, key: 'ayudaBuscadaOtro', label: 'Especifique otra ayuda', control: 'textarea', placeholder: 'Especifique el otro tipo de ayuda buscada' },
...
export const intakeSchema = z.object({
  fechaEntrevista: z.preprocess(preprocessOptionalField, z.coerce.date().optional()),
