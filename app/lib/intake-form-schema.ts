...
export const intakeFieldsDefinition = [
  ...
  // Step 2: Antecedentes
  { step: 2, key: 'medicacionPrev', label: 'Medicación previa', control: 'textarea', placeholder: 'Indique nombre, dosis y duración' },
  { step: 2, key: 'antecedentesSM', label: 'Antecedentes personales y familiares de salud mental', control: 'textarea', placeholder: 'Describa antecedentes personales y familiares relevantes' },
  { step: 2, key: 'biologicos', label: 'Antecedentes biológicos relevantes', control: 'textarea', placeholder: 'Describa antecedentes biológicos relevantes' },

  // Step 3: Motivo de Consulta
  { step: 3, key: 'motivoConsulta', label: 'Motivo de consulta', control: 'textarea' },
  { step: 3, key: 'derivante', label: 'Quién lo deriva', control: 'select', options: ['Psiquiatra', 'Pediatra', 'Familia', 'Asistente social', 'Consulta espontánea'] },
  { step: 3, key: 'presentacion', label: 'Presentación del paciente', control: 'textarea' },
  { step: 3, key: 'diagnosticoTexto', label: '¿Qué le sucede al paciente?', control: 'textarea', options: 'rows:9, placeholder:Describa aspectos diagnósticos' },
  { step: 3, key: 'nivelPersonalidad', label: 'Nivel de organización de la personalidad', control: 'select', options: ['Saludable', 'Neurótico', 'Borderline', 'Psicótico'] },
  { step: 3, key: 'etiologia', label: '¿Por qué le sucede?', control: 'textarea', options: 'rows:9, placeholder:Describa factores predisponentes, desencadenantes y perpetuadores del malestar' },

  // Step 4: Estado Actual
  { step: 4, key: 'malestarPaciente', label: 'Nivel de malestar percibido por el paciente', control: 'select', options: [{ value: '1', label: '1 - Sin malestar' }, { value: '2', label: '2 - Leve' }, { value: '3', label: '3 - Moderado' }, { value: '4', label: '4 - Severo' }, { value: '5', label: '5 - Extremo' }] },
  { step: 4, key: 'atribucionPaciente', label: '¿Cuáles son las causas de su malestar, según el paciente?', control: 'select', options: ['Psicológicas', 'Sociales', 'Familia', 'Trabajo', 'Biológicas', 'Otros'] },
  { step: 4, key: 'ayudaBuscada', label: 'Tipo de ayuda buscada por el paciente', control: 'multiselect', options: [{ value: '1', label: 'Orientación y resolución práctica' }, { value: '2', label: 'Alivio sintomático' }, { value: '3', label: 'Apoyo emocional y contención' }, { value: '4', label: 'Entenderse a sí mismo' }, { value: '5', label: 'Cambio profundo en su personalidad' }, { value: '6', label: 'No sabe qué esperar' }] },
  { step: 4, key: 'gravedadTerapeuta', label: 'Gravedad percibida por el terapeuta', control: 'select', options: ['Ausencia', 'Leve', 'Moderada', 'Grave', 'Extrema'] },
  { step: 4, key: 'funcionamientoGlobal', label: 'Funcionamiento global del paciente', control: 'select', options: [{ value: '1', label: '1 - Funcionamiento superior (sin síntomas)' }, { value: '2', label: '2 - Síntomas mínimos, buen funcionamiento' }, { value: '3', label: '3 - Reacciones transitorias y esperables' }, { value: '4', label: '4 - Síntomas leves o dificultades leves' }, { value: '5', label: '5 - Síntomas moderados o dificultades moderadas' }, { value: '6', label: '6 - Síntomas graves o deterioro grave' }, { value: '7', label: '7 - Deterioro de la realidad o comunicación' }, { value: '8', label: '8 - Influencia de delirios/alucinaciones o deterioro muy grave' }, { value: '9', label: '9 - Peligro de autolesión o daño a otros' }, { value: '10', label: '10 - Peligro persistente de daño severo o acto suicida' }, { value: '11', label: '11 - Información insuficiente' }] },
  { step: 4, key: 'apoyoSocial', label: 'Apoyo social externo', control: 'select', options: [{ value: '1', label: '1 - Inexistente' }, { value: '2', label: '2 - Muy bajo' }, { value: '3', label: '3 - Moderado' }, { value: '4', label: '4 - Bueno' }, { value: '5', label: '5 - Óptimo' }] },
...
export const WIZARD_STEPS = [
  ...
  { id: 3, name: 'Motivo de consulta y Diagnóstico' },
  { id: 4, name: 'Estado Actual' },
