...
const DOMAIN_COLOR_CLASSES: Record<string, string> = {
  ...
  Psicopatología: "bg-purple-100 text-purple-800",
  "Malestar Emocional": "bg-orange-100 text-orange-800",
  "Alianza Terapéutica": "bg-green-100 text-green-800",
  Alianza: "bg-green-100 text-green-800",
  Personalidad: "bg-indigo-100 text-indigo-800",
