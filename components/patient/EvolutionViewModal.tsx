    ...
    >
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          {/* Metadata adicional (si hay más campos) - Oculto para síntesis IA y supervisión */}
          {!['sintesis_ia', 'supervision'].includes(entry.entry_type) && entry.metadata && Object.keys(entry.metadata).filter(key => !['attachments', 'audioTranscriptions'].includes(key)).length > 0 && (
            <div className="mt-6 pt-4 border-t border-gray-100">
