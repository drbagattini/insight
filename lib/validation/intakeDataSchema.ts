...
export const intakeDataSchema = z.object({
  ...
  estadoCivil: z.preprocess(preprocessOptionalField, z.enum(['Soltero/a', 'Casado/a', 'Concubinato estable']).or(z.literal('')).optional()),
  ocupacion: z.preprocess(preprocessOptionalField, z.enum(['Estudiante', 'Trabajo dependiente', 'Trabajo independiente', 'Desempleado', 'Otra']).or(z.literal('')).optional()),
  grupoFamiliar: z.string().optional(),
  motivoConsulta: z.string().optional(),
  derivante: z.preprocess(preprocessOptionalField, z.enum(['Psiquiatra', 'Pediatra', 'Familia', 'Asistente social', 'Consulta espontánea']).or(z.literal('')).optional()),
  presentacion: z.string().optional(),
  diagnosticoTexto: z.string().optional(),
  diagnosticoCodigo: z.string().optional(),
  nivelPersonalidad: z.preprocess(preprocessOptionalField, z.enum(['Saludable', 'Neurótico', 'Borderline', 'Psicótico']).or(z.literal('')).optional()),
  etiologia: z.string().optional(),
  malestarPaciente: z.preprocess(preprocessOptionalField, z.coerce.number().optional()),
  atribucionPaciente: z.preprocess(preprocessOptionalField, z.enum(['Psicológicas', 'Sociales', 'Familia', 'Trabajo', 'Biológicas', 'Otros']).or(z.literal('')).optional()),
  ...
  tipoAyuda: z.array(z.string()).optional(),
