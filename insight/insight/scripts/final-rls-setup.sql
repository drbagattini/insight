...
-- 6. Crear políticas simplificadas

-- Permitir a cualquiera insertar pacientes
CREATE POLICY "allow_insert_paciente"
ON public.users
FOR INSERT
TO public
...
-- 9. Probar inserción de paciente (debe funcionar)
...
-- 10. Probar inserción de psicólogo (debe fallar)
INSERT INTO public.users (
    email,
    password_hash,
    role,
