...
export const intakeFieldsDefinition = [
  ...
  { step: 2, key: 'diagnosticoTexto', label: 'Diagnóstico presuntivo', control: 'textarea' },
  ...
  { step: 2, key: 'etiologia', label: 'Etiología', control: 'textarea' },
  ...
  { step: 3, key: 'atribucionPaciente', label: 'Atribución del malestar por parte del paciente', control: 'select', options: ['Psicológicas', 'Sociales', 'Familia', 'Trabajo', 'Biológicas', 'Otros'] },
